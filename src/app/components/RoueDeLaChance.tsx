// re-push: commit technique pour forcer un nouveau push
      ...
      <div className="mt-5 flex flex-col items-center gap-4">
        <div className="relative">
            ...
            <svg viewBox={`0 0 ${WHEEL_SIZE} ${WHEEL_SIZE}`} className="w-full h-full">
              {activeItems.length === 0 ? (
                ...
                activeItems.map((item, index) => {
                  ...
                  const labelStartR = 17; // rayon de départ du texte (très proche du centre)
                  ...
                  function measureTextWidth(text: string, fontSize: number, fontWeight: string = "800", fontFamily = "Inter, Arial, sans-serif") {
          ...
          <div className="absolute inset-0 z-[15] pointer-events-none">
            <svg viewBox={`0 0 ${WHEEL_SIZE} ${WHEEL_SIZE}`} className="w-full h-full">
              <polygon
                points={`${WHEEL_CENTER - 12},6 ${WHEEL_CENTER + 12},6 ${WHEEL_CENTER},20`}
                fill="white"
