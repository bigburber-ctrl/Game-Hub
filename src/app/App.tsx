...
export default function App() {
  ...
  return (
    <div className="min-h-dvh bg-[#0f172a] text-slate-100 font-sans selection:bg-purple-500/30 overflow-x-hidden">
      ...
      {/* Bouton Plus et menu flottant, toujours visible, hors du flux principal */}
      <div className="fixed z-40 top-6 left-6 flex flex-col items-start pointer-events-none">
          ...
          {gameState === "home" && (
            ...
            >
              ...
              <div className="text-center space-y-2 relative">
                ...
                {/* ...rien, le bouton Plus est maintenant global... */}
