              ...
              <div className="text-center space-y-2 relative">
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  <button
                    ...
                    className="absolute -top-50 right-0 w-10 h-10 flex items-center justify-center rounded-md bg-slate-800/50 border border-slate-700/50 text-white font-bold shadow-lg hover:bg-slate-700 transition-all focus:outline-none focus:ring-2 focus:ring-purple-400"
